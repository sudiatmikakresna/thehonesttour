  ...
  return (
    <section className="py-16 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Two Column Layout: Feedback Slider + Instagram */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto">
          {/* Left Column: Feedback Slider */}
                ...
                {feedbacks.map((feedback) => (
                  ...
                  >
                    <div className="bg-white rounded-xl shadow-lg p-6 h-full flex flex-col transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                      ...
                      {/* Comment */}
                      <p className="text-gray-700 text-sm md:text-base leading-relaxed mb-6 flex-grow line-clamp-6">
            ...
            {feedbacks.length > 1 && (
              <>
                <Button
                  ...
                  className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white hover:bg-gray-100 shadow-lg rounded-full w-10 h-10 z-10"
                ...
                <Button
                  ...
                  size="icon"
                  onClick={goToNext}
                  className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white hover:bg-gray-100 shadow-lg rounded-full w-10 h-10 z-10"
          ...
          <div className="flex flex-col">
            <div className="bg-white rounded-xl shadow-lg p-4 flex-grow flex items-center justify-center">
              <iframe
